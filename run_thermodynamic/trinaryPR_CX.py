...
model.pressure = Param(initialize=124400)
model.temperature = Param(initialize=89.4446)
dict = {
'Oxygen':7.94000000000000e-07,
'Argon':0.988273950000000,
'Nitrogen':0.0117252500000000
}
model.x = Param(model.Component, initialize=dict)
dict = {
'Oxygen':7.02000000000000e-07,
'Argon':0.961808760000000,
'Nitrogen':0.0381905300000000
}
model.y = Param(model.Component, initialize=dict)
...
print(value(model.HV))
print(value(model.HL))