...
#相较于irc_system，该模型对reflux进行了spec
...
model.vaporLeavingMolarFlow = Param(model.TopTray,initialize={NumberOfTrays:4315.151302996267})
model.vaporLeavingMolarFraction = Param(model.TopTray,model.Component,initialize=\
    {(NumberOfTrays,'Nitrogen'):0.8567158672293502,(NumberOfTrays,'Oxygen'):0.1432841327706497})
model.trayPressure = Param(model.TopAndBottomTray,initialize={1:564,NumberOfTrays:539.56})
model.trayTemperature  = Param(model.TopAndBottomTray,initialize={1:-173.75200000000004,NumberOfTrays:-175.51168000000004})
#--------------IRC指定-----------------

MinimalTempDiff = 0.1
model.expandValveDeltaP = Var(initialize=100, within=NonNegativeReals)
...
model.ircRefluxMolarFlow=Param(initialize=4315.151302996267*0.6)
