...
model.ircRebTemperature=Param(bounds=(-230,-100),initialize=-180)
model.ircRebPressure=Param(bounds=(0,1000),initialize=564-model.expandValveDeltaP.value)
def _ircOutExpandValveMolarEnthalpy(m):
    return LiquidPhaseEnthalpy(m.ircRebTemperature, m.ircRebPressure, m.liquidLeavingMolarFraction[1,'Oxygen'],
