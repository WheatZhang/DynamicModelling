...
FeedLiquidPhaseMolarFrac = {'Oxygen':model.FeedLiquidPhaseMolarFrac._data['Oxygen'].value,\
                            'Nitrogen':model.FeedLiquidPhaseMolarFrac._data['Nitrogen'].value}
FeedVaporPhaseMolarFrac = {'Oxygen':model.FeedVaporPhaseMolarFrac._data['Oxygen'].value,\
                            'Nitrogen':model.FeedVaporPhaseMolarFrac._data['Nitrogen'].value}
FeedMolarFlow = model.FeedMolarFlow.value
FeedMolarFraction = {'Oxygen':model.FeedMolarFraction._data['Oxygen'],\
                            'Nitrogen':model.FeedMolarFraction._data['Nitrogen']}
feedEnthalpy = model.feedEnthalpy.value
