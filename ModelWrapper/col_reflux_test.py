...
setting = {}
setting['RefluxRatio'] = wm.SettingItem(init_value=0.5,bound=(0,1),domain=(0.5,0.8))
setting['RefluxTemperature'] = wm.SettingItem(init_value=-205,bound=(-230,-100),domain=(-190,-160))
setting['RefluxPressure'] = wm.SettingItem(init_value=539.56,bound=(300,600),domain=(500,600))
setting['TopVaporMolarFlow'] = wm.SettingItem(init_value=2000,bound=(0,10000),domain=(200,6000))
setting['BottomLiquidMolarFlow'] = wm.SettingItem(init_value=1000,bound=(0,10000),domain=(50,2000))
setting['TopVaporNitrogenMolarFrac'] = wm.SettingItem(init_value=0.98,bound=(0,1),domain=(0.8,0.99))
setting['BottomLiquidOxygenMolarFrac'] = wm.SettingItem(init_value=0.4,bound=(0,1),domain=(0.2,0.9))
w_model = wm.WrappedConcreteModel(3, setting)
w_model.pre_setting = pre_setting
w_model.post_setting = post_setting
# w_model.instancialize(['RefluxRatio','RefluxTemperature','RefluxPressure'])
w_model.instancialize(['TopVaporMolarFlow','BottomLiquidMolarFlow','RefluxPressure'])
print(w_model.solve())
