...
def LiquidPhaseEnthalpyPartialT(temperature, pressure, oxygen, nitrogen):
    return liquid_nitrogen_enthalpy_DT(pressure, temperature) * nitrogen + liquid_oxygen_enthalpy_DT(pressure,emperature) * oxygen
#----------------------------------------
###
#   Enthalpy expression
###
...
def _trayHoldupAmountinitCond(m):
    yield m.trayHoldupAmount[0,1] == 106.6731903980423
    yield m.trayHoldupAmount[0,2] == 66.60631285476649
    yield m.trayHoldupAmount[0,3] == 66.49070857486089
    yield m.trayHoldupAmount[0,4] == 66.31907395195175
    yield m.trayHoldupAmount[0,5] == 66.069929820973
    yield m.trayHoldupAmount[0,6] == 65.71622209583538
    yield m.trayHoldupAmount[0,7] == 65.22702830414701
    yield m.trayHoldupAmount[0,8] == 64.57214593609386
    yield m.trayHoldupAmount[0,9] == 63.73157842131897
    yield m.trayHoldupAmount[0,10] ==62.70940719713927
model.trayHoldupAmountInitCond = ConstraintList(rule=_trayHoldupAmountinitCond)
trayCompHoldupAmountDict = {
(10, 1, 'Nitrogen') :  69.20300116650358,
  (10, 1, 'Oxygen') :  37.47018923153872,
(10, 2, 'Nitrogen') :  43.32451606117309,
  (10, 2, 'Oxygen') : 23.281796793593386,
(10, 3, 'Nitrogen') :  43.51274057877498,
  (10, 3, 'Oxygen') : 22.977967996085905,
(10, 4, 'Nitrogen') :  43.87032207226221,
  (10, 4, 'Oxygen') :  22.44875187968953,
(10, 5, 'Nitrogen') : 44.462210860070805,
  (10, 5, 'Oxygen') : 21.607718960902208,
(10, 6, 'Nitrogen') :  45.37551945401512,
  (10, 6, 'Oxygen') : 20.340702641820254,
(10, 7, 'Nitrogen') : 46.720137181201956,
  (10, 7, 'Oxygen') :  18.50689112294506,
(10, 8, 'Nitrogen') :  48.62119588518929,
  (10, 8, 'Oxygen') :  15.95095005090458,
(10, 9, 'Nitrogen') :  51.19733219274718,
  (10, 9, 'Oxygen') : 12.534246228571792,
(10, 10, 'Nitrogen') :  54.52003539597207,
 (10, 10, 'Oxygen') :  8.189371801167196
}
...
load_initials.load_display_modified_t(model, "initials.txt",pe_list,[0,0.310102,1.289898,2.0,2.310102,3.289898,4.0,4.310102,5.289898,6.0,6.310102,7.289898,8.0,8.310102,9.289898,10] )
