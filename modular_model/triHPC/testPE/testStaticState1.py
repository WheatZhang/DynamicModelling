...
#          Pyomo
#---------------------------------
testTask.generatePyomoModel("pyomoModel1.py")
...
# with open('HPC_SS_display.txt', 'w') as file:
#     test_model.display(ostream=file)
ModularTask.InitValueTools.to_template(test_model, 'StaticInitValue1.txt')