...
#===================================
#--------HPCFeed1---------
test_model.HPCFeed1MFlow = Param(test_model.ParaTime, initialize = 3326.000000*1.2)
dict = {}
for i in test_model.ParaTime.value:
	dict[i,"Oxygen"] = 0.209500
	dict[i,"Nitrogen"] = 0.781200
	dict[i,"Argon"] = 0.009300
test_model.HPCFeed1MFrac = Param(test_model.ParaTime, test_model.Component, initialize = dict)
...
for i in test_model.ParaTime.value:
	...
	dict[i,"Nitrogen"] = 0.781200
	dict[i,"Argon"] = 0.009300
test_model.HPCFeed2MFrac = Param(test_model.ParaTime, test_model.Component, initialize = dict)
...
test_model.HPCSumpLCParaMVSS = Param(initialize=2137.654020)
...
test_model.HPCExt6MFlow = Var(test_model.Time, within=NonNegativeReals)
test_model.HPCExt6MFrac = Var(test_model.Time, test_model.Component, bounds=(0,1))
test_model.HPCExt6MEtlp = Var(test_model.Time)
test_model.HPCExt22MFlow = Var(test_model.Time, within=NonNegativeReals)
...
def HPCEngBlnc(m,time,tray):
	if tray == 1:
		return (m.HPCLiqLvMFlow[time,tray + 1] * m.HPCLiqLvMEtlp[time,tray+1] \
		        ...
		        +m.HPCFeed1MFlow[time]*m.HPCFeed1MEtlp[time]-m.HPCDtTrayMEtlpHldp[time,tray]-m.HPCUALeakage*(m.HPCAmbientTemp-m.HPCTrayTemp[time,tray]))*0.000010 == 0
	elif tray == 4:
		return (m.HPCLiqLvMFlow[time,tray + 1] * m.HPCLiqLvMEtlp[time,tray+1] \
		        + m.HPCVapLvMFlow[time,tray-1] * m.HPCVapLvMEtlp[time,tray-1] \
		        - m.HPCLiqLvMFlow[time,tray] * m.HPCLiqLvMEtlp[time,tray] \
		        - m.HPCVapLvMFlow[time,tray] * m.HPCVapLvMEtlp[time,tray]\
		        +m.HPCFeed2MFlow[time]*m.HPCFeed2MEtlp[time]-m.HPCDtTrayMEtlpHldp[time,tray]-m.HPCUALeakage*(m.HPCAmbientTemp-m.HPCTrayTemp[time,tray]))*0.000010 == 0
	elif tray == 6:
		return (m.HPCLiqLvMFlow[time,tray + 1] * m.HPCLiqLvMEtlp[time,tray+1] \
		        + m.HPCVapLvMFlow[time,tray-1] * m.HPCVapLvMEtlp[time,tray-1] \
		        - m.HPCLiqLvMFlow[time,tray] * m.HPCLiqLvMEtlp[time,tray] \
		        - m.HPCVapLvMFlow[time,tray] * m.HPCVapLvMEtlp[time,tray]\
		        -m.HPCExt6MFlow[time]*m.HPCExt6MEtlp[time]-m.HPCDtTrayMEtlpHldp[time,tray]-m.HPCUALeakage*(m.HPCAmbientTemp-m.HPCTrayTemp[time,tray]))*0.000010 == 0
	elif tray == 22:
		return (m.HPCLiqLvMFlow[time,tray + 1] * m.HPCLiqLvMEtlp[time,tray+1] \
		        + m.HPCVapLvMFlow[time,tray-1] * m.HPCVapLvMEtlp[time,tray-1] \
		        - m.HPCLiqLvMFlow[time,tray] * m.HPCLiqLvMEtlp[time,tray] \
		        - m.HPCVapLvMFlow[time,tray] * m.HPCVapLvMEtlp[time,tray]\
		        -m.HPCExt22MFlow[time]*m.HPCExt22MEtlp[time]-m.HPCDtTrayMEtlpHldp[time,tray]-m.HPCUALeakage*(m.HPCAmbientTemp-m.HPCTrayTemp[time,tray]))*0.000010 == 0
	elif tray == 42:
		return (m.HPCCondRefMFlow[time] * m.HPCCondOutMEtlp[time] \
		        + m.HPCVapLvMFlow[time,tray-1] * m.HPCVapLvMEtlp[time,tray-1] \
		        - m.HPCLiqLvMFlow[time,tray] * m.HPCLiqLvMEtlp[time,tray] \
		        - m.HPCVapLvMFlow[time,tray] * m.HPCVapLvMEtlp[time,tray]-m.HPCDtTrayMEtlpHldp[time,tray]-m.HPCUALeakage*(m.HPCAmbientTemp-m.HPCTrayTemp[time,tray]))*0.000010 == 0
	else:
		return (m.HPCLiqLvMFlow[time,tray + 1] * m.HPCLiqLvMEtlp[time,tray+1] \
		        + m.HPCVapLvMFlow[time,tray-1] * m.HPCVapLvMEtlp[time,tray-1] \
		        - m.HPCLiqLvMFlow[time,tray] * m.HPCLiqLvMEtlp[time,tray] \
		        - m.HPCVapLvMFlow[time,tray] * m.HPCVapLvMEtlp[time,tray] \
		        - m.HPCDtTrayMEtlpHldp[time,tray]-m.HPCUALeakage*(m.HPCAmbientTemp-m.HPCTrayTemp[time,tray]))*0.000010 == 0
...
def HPCPProf(m, time, tray):
	return ((m.HPCTopPressure-m.HPCBtmPressure)/41*(tray-1)+m.HPCBtmPressure - m.HPCTrayPressure[time, tray])*0.010000 == 0
test_model.HPCPProf = Constraint(test_model.Time, test_model.HPCTrays, rule=HPCPProf)
#--------HPC Extractions---------
def HPCExt6MFlowSpec(m, time):
	return (m.HPCExt6MFlow[time] - 829.800000)*  0.001000 == 0
test_model.HPCExt6MFlowSpec = Constraint(test_model.Time, rule=HPCExt6MFlowSpec)
...
def HPCExt22MFlowSpec(m, time):
	return (m.HPCExt22MFlow[time] - 47.290000)*  0.001000 == 0
test_model.HPCExt22MFlowSpec = Constraint(test_model.Time, rule=HPCExt22MFlowSpec)
...
def HPCICTrayMHldp(m):
	yield m.HPCTrayMHldp[0, 1] == 213.765402
	yield m.HPCTrayMHldp[0, 2] == 209.679981
	yield m.HPCTrayMHldp[0, 3] == 211.571570
	yield m.HPCTrayMHldp[0, 4] == 213.491754
	yield m.HPCTrayMHldp[0, 5] == 109.226875
	yield m.HPCTrayMHldp[0, 6] == 110.120049
	yield m.HPCTrayMHldp[0, 7] == 194.769634
	yield m.HPCTrayMHldp[0, 8] == 196.454415
	yield m.HPCTrayMHldp[0, 9] == 198.090694
	yield m.HPCTrayMHldp[0, 10] == 199.618133
	yield m.HPCTrayMHldp[0, 11] == 200.987408
	yield m.HPCTrayMHldp[0, 12] == 202.174603
	yield m.HPCTrayMHldp[0, 13] == 203.173885
	yield m.HPCTrayMHldp[0, 14] == 203.994313
	yield m.HPCTrayMHldp[0, 15] == 204.652460
	yield m.HPCTrayMHldp[0, 16] == 205.170405
	yield m.HPCTrayMHldp[0, 17] == 205.570891
	yield m.HPCTrayMHldp[0, 18] == 205.875408
	yield m.HPCTrayMHldp[0, 19] == 206.102993
	yield m.HPCTrayMHldp[0, 20] == 206.269528
	yield m.HPCTrayMHldp[0, 21] == 206.388465
	yield m.HPCTrayMHldp[0, 22] == 206.470152
	yield m.HPCTrayMHldp[0, 23] == 206.523171
	yield m.HPCTrayMHldp[0, 24] == 206.552518
	yield m.HPCTrayMHldp[0, 25] == 206.563869
	yield m.HPCTrayMHldp[0, 26] == 206.561426
	yield m.HPCTrayMHldp[0, 27] == 206.548313
	yield m.HPCTrayMHldp[0, 28] == 206.526957
	yield m.HPCTrayMHldp[0, 29] == 206.499159
	yield m.HPCTrayMHldp[0, 30] == 206.466288
	yield m.HPCTrayMHldp[0, 31] == 206.429298
	yield m.HPCTrayMHldp[0, 32] == 206.389016
	yield m.HPCTrayMHldp[0, 33] == 206.346016
	yield m.HPCTrayMHldp[0, 34] == 206.300660
	yield m.HPCTrayMHldp[0, 35] == 206.253431
	yield m.HPCTrayMHldp[0, 36] == 206.204468
	yield m.HPCTrayMHldp[0, 37] == 206.154039
	yield m.HPCTrayMHldp[0, 38] == 206.102239
	yield m.HPCTrayMHldp[0, 39] == 206.047788
	yield m.HPCTrayMHldp[0, 40] == 205.995352
	yield m.HPCTrayMHldp[0, 41] == 205.940479
	yield m.HPCTrayMHldp[0, 42] == 205.884974
test_model.HPCICTrayMHldp = ConstraintList(rule=HPCICTrayMHldp)
def HPCICTrayMCompHldp(m):
	yield m.HPCTrayMCompHldp[0, 1, "Nitrogen"] == 133.010419
	yield m.HPCTrayMCompHldp[0, 1, "Oxygen"] == 77.820479
	yield m.HPCTrayMCompHldp[0, 2, "Nitrogen"] == 137.083342
	yield m.HPCTrayMCompHldp[0, 2, "Oxygen"] == 69.725823
	yield m.HPCTrayMCompHldp[0, 3, "Nitrogen"] == 145.230381
	yield m.HPCTrayMCompHldp[0, 3, "Oxygen"] == 63.526307
	yield m.HPCTrayMCompHldp[0, 4, "Nitrogen"] == 153.419375
	yield m.HPCTrayMCompHldp[0, 4, "Oxygen"] == 57.387554
	yield m.HPCTrayMCompHldp[0, 5, "Nitrogen"] == 80.108542
	yield m.HPCTrayMCompHldp[0, 5, "Oxygen"] == 27.645201
	yield m.HPCTrayMCompHldp[0, 6, "Nitrogen"] == 83.806042
	yield m.HPCTrayMCompHldp[0, 6, "Oxygen"] == 24.659508
	yield m.HPCTrayMCompHldp[0, 7, "Nitrogen"] == 153.766826
	yield m.HPCTrayMCompHldp[0, 7, "Oxygen"] == 37.802483
	yield m.HPCTrayMCompHldp[0, 8, "Nitrogen"] == 160.615177
	yield m.HPCTrayMCompHldp[0, 8, "Oxygen"] == 32.376136
	yield m.HPCTrayMCompHldp[0, 9, "Nitrogen"] == 167.234805
	yield m.HPCTrayMCompHldp[0, 9, "Oxygen"] == 27.179895
	yield m.HPCTrayMCompHldp[0, 10, "Nitrogen"] == 173.394257
	yield m.HPCTrayMCompHldp[0, 10, "Oxygen"] == 22.393554
	yield m.HPCTrayMCompHldp[0, 11, "Nitrogen"] == 178.925515
	yield m.HPCTrayMCompHldp[0, 11, "Oxygen"] == 18.138672
	yield m.HPCTrayMCompHldp[0, 12, "Nitrogen"] == 183.742992
	yield m.HPCTrayMCompHldp[0, 12, "Oxygen"] == 14.473718
	yield m.HPCTrayMCompHldp[0, 13, "Nitrogen"] == 187.832821
	yield m.HPCTrayMCompHldp[0, 13, "Oxygen"] == 11.401753
	yield m.HPCTrayMCompHldp[0, 14, "Nitrogen"] == 191.233187
	yield m.HPCTrayMCompHldp[0, 14, "Oxygen"] == 8.885252
	yield m.HPCTrayMCompHldp[0, 15, "Nitrogen"] == 194.013713
	yield m.HPCTrayMCompHldp[0, 15, "Oxygen"] == 6.861432
	yield m.HPCTrayMCompHldp[0, 16, "Nitrogen"] == 196.260011
	yield m.HPCTrayMCompHldp[0, 16, "Oxygen"] == 5.258995
	yield m.HPCTrayMCompHldp[0, 17, "Nitrogen"] == 198.059825
	yield m.HPCTrayMCompHldp[0, 17, "Oxygen"] == 4.005512
	yield m.HPCTrayMCompHldp[0, 18, "Nitrogen"] == 199.495031
	yield m.HPCTrayMCompHldp[0, 18, "Oxygen"] == 3.034456
	yield m.HPCTrayMCompHldp[0, 19, "Nitrogen"] == 200.637955
	yield m.HPCTrayMCompHldp[0, 19, "Oxygen"] == 2.288123
	yield m.HPCTrayMCompHldp[0, 20, "Nitrogen"] == 201.548914
	yield m.HPCTrayMCompHldp[0, 20, "Oxygen"] == 1.717908
	yield m.HPCTrayMCompHldp[0, 21, "Nitrogen"] == 202.278248
	yield m.HPCTrayMCompHldp[0, 21, "Oxygen"] == 1.284294
	yield m.HPCTrayMCompHldp[0, 22, "Nitrogen"] == 202.865410
	yield m.HPCTrayMCompHldp[0, 22, "Oxygen"] == 0.955804
	yield m.HPCTrayMCompHldp[0, 23, "Nitrogen"] == 203.342265
	yield m.HPCTrayMCompHldp[0, 23, "Oxygen"] == 0.707740
	yield m.HPCTrayMCompHldp[0, 24, "Nitrogen"] == 203.727342
	yield m.HPCTrayMCompHldp[0, 24, "Oxygen"] == 0.523259
	yield m.HPCTrayMCompHldp[0, 25, "Nitrogen"] == 204.041680
	yield m.HPCTrayMCompHldp[0, 25, "Oxygen"] == 0.386330
	yield m.HPCTrayMCompHldp[0, 26, "Nitrogen"] == 204.301109
	yield m.HPCTrayMCompHldp[0, 26, "Oxygen"] == 0.284878
	yield m.HPCTrayMCompHldp[0, 27, "Nitrogen"] == 204.517633
	yield m.HPCTrayMCompHldp[0, 27, "Oxygen"] == 0.209816
	yield m.HPCTrayMCompHldp[0, 28, "Nitrogen"] == 204.700347
	yield m.HPCTrayMCompHldp[0, 28, "Oxygen"] == 0.154345
	yield m.HPCTrayMCompHldp[0, 29, "Nitrogen"] == 204.856151
	yield m.HPCTrayMCompHldp[0, 29, "Oxygen"] == 0.113399
	yield m.HPCTrayMCompHldp[0, 30, "Nitrogen"] == 204.990171
	yield m.HPCTrayMCompHldp[0, 30, "Oxygen"] == 0.083144
	yield m.HPCTrayMCompHldp[0, 31, "Nitrogen"] == 205.106304
	yield m.HPCTrayMCompHldp[0, 31, "Oxygen"] == 0.060866
	yield m.HPCTrayMCompHldp[0, 32, "Nitrogen"] == 205.207578
	yield m.HPCTrayMCompHldp[0, 32, "Oxygen"] == 0.044424
	yield m.HPCTrayMCompHldp[0, 33, "Nitrogen"] == 205.296260
	yield m.HPCTrayMCompHldp[0, 33, "Oxygen"] == 0.032334
	yield m.HPCTrayMCompHldp[0, 34, "Nitrogen"] == 205.374015
	yield m.HPCTrayMCompHldp[0, 34, "Oxygen"] == 0.023464
	yield m.HPCTrayMCompHldp[0, 35, "Nitrogen"] == 205.442343
	yield m.HPCTrayMCompHldp[0, 35, "Oxygen"] == 0.016939
	yield m.HPCTrayMCompHldp[0, 36, "Nitrogen"] == 205.502193
	yield m.HPCTrayMCompHldp[0, 36, "Oxygen"] == 0.012156
	yield m.HPCTrayMCompHldp[0, 37, "Nitrogen"] == 205.554443
	yield m.HPCTrayMCompHldp[0, 37, "Oxygen"] == 0.008629
	yield m.HPCTrayMCompHldp[0, 38, "Nitrogen"] == 205.599705
	yield m.HPCTrayMCompHldp[0, 38, "Oxygen"] == 0.006027
	yield m.HPCTrayMCompHldp[0, 39, "Nitrogen"] == 205.638281
	yield m.HPCTrayMCompHldp[0, 39, "Oxygen"] == 0.004133
	yield m.HPCTrayMCompHldp[0, 40, "Nitrogen"] == 205.673783
	yield m.HPCTrayMCompHldp[0, 40, "Oxygen"] == 0.002723
	yield m.HPCTrayMCompHldp[0, 41, "Nitrogen"] == 205.702025
	yield m.HPCTrayMCompHldp[0, 41, "Oxygen"] == 0.001702
	yield m.HPCTrayMCompHldp[0, 42, "Nitrogen"] == 205.725154
	yield m.HPCTrayMCompHldp[0, 42, "Oxygen"] == 0.000933
test_model.HPCICTrayMCompHldp = ConstraintList(rule=HPCICTrayMCompHldp)
def HPCICDtTrayMEtlpHldp(m, tray):
	if tray == 1:
...
test_model.HPCICDtTrayMEtlpHldp = Constraint(test_model.HPCTrays, rule=HPCICDtTrayMEtlpHldp)
...
def HPCSumpLevelCal(m, time):
	return m.HPCSumpHldpLevel[time] - m.HPCSumpMHldp[time] / m.HPCSumpLiqRho / m.HPCSumpSumpCSArea == 0
...
def HPCSumpICMHldp(m):
	return m.HPCSumpMHldp[0] == 3000.000000
test_model.HPCSumpICMHldp = Constraint(rule=HPCSumpICMHldp)
def HPCSumpICCompHldp(m):
	yield m.HPCSumpMCompHldp[0,"Nitrogen"] == 1866.678398
	yield m.HPCSumpMCompHldp[0,"Oxygen"] == 1092.138549
