...
#===================================
#--------HPCFeed1---------
test_model.HPCFeed1MFlow = Param(test_model.ParaTime, initialize = 3326.000000)
dict = {}
...
test_model.HPCTopPressure = Param(test_model.ParaTime, initialize = 538.600000)
...
dict = {
    ...
    9.644949:11.9289898,
    10:12.0}
test_model.HPCUALeakage = Param(test_model.ParaTime, initialize = dict)
...
def HPCSumpICCompHldp(m):
	yield m.HPCSumpMCompHldp[0,"Nitrogen"] == m.HPCSumpLevelSP[0]*m.HPCSumpSumpCSArea                                *m.HPCSumpLiqRho[0]*0.622226
	yield m.HPCSumpMCompHldp[0,"Oxygen"] == m.HPCSumpLevelSP[0]*m.HPCSumpSumpCSArea                                *m.HPCSumpLiqRho[0]*0.364046
