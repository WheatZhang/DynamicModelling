...
axes[0].plot(time,y1, label = 'y1-rk',c='b')
axes[1].plot(time,y2, label = 'y2-rk',c='b')

from use_direct_disc_method import time as direct_disc_time,y1 as direct_disc_y1,y2 as direct_disc_y2
axes[0].plot(direct_disc_time,direct_disc_y1, label = 'y1-fe',c='r')
axes[1].plot(direct_disc_time,direct_disc_y2, label = 'y2-fe',c='r')
for ax in axes:
